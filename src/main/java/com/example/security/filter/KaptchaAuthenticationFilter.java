...
public class KaptchaAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void validateCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ImageCodeTo codeInSession = (ImageCodeTo) sessionStrategy.getAttribute(servletWebRequest, "captcha");
        ...
        if (codeInSession.idExpire()) {
            sessionStrategy.removeAttribute(servletWebRequest, "captcha");
